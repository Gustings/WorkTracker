# Automated Build, Sign, and Installer Compile Script for Work Tracker v1.5.3
...
# 5. Sign Installer
Write-Host "`n=== Step 5: Digitally Signing WorkTrackerSetup-1.5.3.exe ==="
$setupPath = "..\Installers\WorkTrackerSetup-1.5.3.exe"
...
Write-Host "`n=== SUCCESS! Version 1.5.3 has been published, signed, and packaged! ==="
